...
openssl ca -config "$CONFIGURATION" -batch -days 365 -selfsign -keyfile "$PRIVATE_KEY_LOCATION" -in "$REQUEST_LOCATION" -out "$TEMP_CERTIFICATE_LOCATION" -subj "$SUBJ" -passin pass:pass -extensions v3_self_signed
