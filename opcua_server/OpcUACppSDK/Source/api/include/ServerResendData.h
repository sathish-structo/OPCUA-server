...
#ifndef SERVERRESENDDATA_H
#define SERVERRESENDDATA_H
#if TB5_ALARMS
#include "Base.h"
#include "Enums.h"
...
namespace SoftingOPCToolbox5
{
	...
	namespace Server
	{
		...
		*
		* ResendData allows a client to request a refresh of all condition instances that currently are in
		...
		* require resynchronization with the server. */
		class TBC_EXPORT ResendData
			: public Method
		{
		public:
			/*! Constructs a new ResendData instance */
			static ObjectPointer<ResendData> create();

			/*! Constructor that shall be used by derived classes whose instances are created by the Creator object factory */
			ResendData(TBHandle otbHandle);
		...
		private:
			...
			ResendData& operator=(const ResendData&);
			/*! Forbid use of copy constructor */
			ResendData(const ResendData&);
		};
		typedef ObjectPointer<ResendData> ResendDataPtr;
		typedef ObjectPointer<const ResendData> ResendDataConstPtr;

	} // end Server namespace
} // toolbox namespace end

#endif
#endif	// SERVERRESENDDATA_H
