	...
	namespace Server
	{
		...
		* @see HistoryReadEventTransaction for details on how to handle requests. */
		...
		public:
			...
			* e.g. via Server::HistoryReadEventContinuationPoint::create().
			*
			...
			*		after the server application has provided all information that is required to continue the request. */
			DEPRECATED(EnumStatusCode createContinuationPoint(HistoryReadEventContinuationPointPtr& continuationPoint));
